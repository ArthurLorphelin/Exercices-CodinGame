...
def find_landing_zone(surface: List[Tuple[int, int]]) -> Tuple[int, int, int]:
...
def find_next_highest_obstacle(x_position: int, landing_zone_start: int, landing_zone_end: int,
...
def calculate_rover_altitude(y_position: int, altitude_landing_zone: int) -> int:
...
def adjust_rotate_to_reach_landing_zone(y_position: int, x_position: int, landing_zone_start: int,
                                        landing_zone_end: int,altitude_landing_zone: int, current_rotate: int,
                                        next_obstacle_altitude: int) -> int:
...
def adjust_rotate_opposite_direction(x_position: int, y_position: int, altitude_landing_zone: int,
                                     horizontal_speed: float, current_rotate: int, next_obstacle_altitude: int,
                                     landing_zone_start: int, landing_zone_end: int) -> int:
    rover_altitude = calculate_rover_altitude(y_position, altitude_landing_zone)
    max_tilt = MAX_TILT_LOW if (rover_altitude < ALTITUDE_THRESHOLD or (
...
def adjust_rotate_to_zero(current_rotate: int) -> int:
...
def compute_power_in_optimal_conditions(vertical_speed: float) -> int:
...
def compute_power_approaching_landing_zone(vertical_speed: float, current_rotate: int, y_position: int,
                                           next_obstacle_altitude: int) -> int:
...
def will_rover_land_in_zone(x_position: int, y_position: int, altitude_landing_zone: int, horizontal_speed: float,
                            vertical_speed: float, landing_zone_start: int, landing_zone_end: int) -> bool:
    impact_x = x_position + (
...
def is_optimal_conditions_to_land(x_position: int, y_position: int, altitude_landing_zone: int, horizontal_speed: float,
                                  vertical_speed: float, landing_zone_start: int, landing_zone_end: int,
                                  current_rotate: int) -> bool:
...
def control_lander(surface: List[Tuple[int, int]]):
